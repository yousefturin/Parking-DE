...
from matplotlib import pyplot as plt  # for seeing images
...
class ObjectDetection:
    ...
    def plot_boxes(self, results, frame):
        ...
        for i in range(n):
            ...
            if row[4] >= 0.3:
                ...
                if self.class_to_label(labels[i]) == 'Full':
                    ...
                    cv2.putText(frame, self.class_to_label(labels[i]), (x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 0.4, full, 1)
                    ...
                    cv2.putText(frame, self.class_to_label(labels[i]), (x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 0.4, empty,
                                1)
                    cv2.putText(frame, str(lot_number), (x2, y2), cv2.FONT_HERSHEY_SIMPLEX, 0.4, full, 1)
                    carCounter_empty += 1
                    lot_number += 1
        ...
        print("full:", carCounter_full)
        print("empty:", carCounter_empty)
    ...
    def __call__(self):
        ...
        while True:
            ...
            cv2.putText(frame, f'FPS: {int(fps)}', (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1)
